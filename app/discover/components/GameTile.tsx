...
export interface Props {
    item: any;
    setSelectedGameSlug: Dispatch<SetStateAction<any>>;
}

const GameTile = (props: Props) => {
    return (
        <div className='w-[160px] sm:w-[200px] md:w-[240px] lg:w-[280px] inline-block cursor-pointer relative' onClick={() => props.setSelectedGameSlug(props.item?.slug)}>
